    ...
    return (
      <div className="pb-6">
        <header className="bg-surface border-app pt-safe border-b px-5 pb-6">
          <h1 className="text-body pt-4 text-[19px] font-extrabold">Fee Saya</h1>
        </header>
        <div className="border-app bg-surface mx-5 mt-5 rounded-[var(--radius-card)] border border-dashed px-5 py-12 text-center">
